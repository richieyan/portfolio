...
from backend.app.db.schemas import ValuationRead
...
@router.post("/{ts_code}/refresh", response_model=List[ValuationRead])
...
@router.get("/{ts_code}", response_model=List[ValuationRead])
